...
import { IoLocationSharp, FaCalendarAlt, HiOutlineSwitchHorizontal, MdAirlineSeatReclineExtra, IoLogoUsd, FaClock } from "../../../utils/icons/icons.js";
...
const CreateFlight = () => {
  ...
  const AirlineMapped = (() => {
    ...
    const optionMapped = airlineMappedDp.map(dep => <option key={dep} value={dep}>{dep}</option>)
    return optionMapped
  })
  ...
  return (
    <div className="div_container_create_flight">
      <div className="selected_div_create_flight">
        <select value={airline} className="select_createFlight" onChange={handleAirline}>
          <option value="0" disabled>Aerolineas</option>
      ...
      <div className="contenedor">
        <div className="div_search">
          ...
          <div className="div_destinoCapacidad">
            <div className="div_destino">
              ...
              <input type="text" placeholder="Origen*" onChange={handleDeparture} />
              <HiOutlineSwitchHorizontal className="switch_airline" />
              <IoLocationSharp className="location1_airline" />
              <input type="text" placeholder="Destino*" onChange={handleArrival} />
            </div>

            <div className="div_capacidad">
              <MdAirlineSeatReclineExtra className="location1_airline" />
              <input type="number" placeholder="Cap. Economicos*" onChange={handleEconomic} />
              <MdAirlineSeatReclineExtra className="seat1_airline" />
              <input type="number" placeholder="Cap. Primera Clase*" onChange={handleFirstClass} />
          ...
          <FaCalendarAlt onClick={openCalendarGo} className="calendar1_airline" />
              <input
        ...
        <button disabled={airline == "0"} onClick={handleSend}>Crear</button>
      </div>
    </div>
  );
};
